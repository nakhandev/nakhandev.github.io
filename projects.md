                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="tech-stack-badges">
                                ...
                                <span class="badge bg-dark text-light me-1 mb-1">REST API</span>
                            </div>
                        </div>
                        <div class="project-meta d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                <i class="bi bi-calendar me-1"></i>Active Project
                            </small>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="tech-stack-badges">
                                <span class="badge bg-dark text-light me-1 mb-1">Java</span>
                                <span class="badge bg-dark text-light me-1 mb-1">Spring Boot</span>
                                <span class="badge bg-dark text-light me-1 mb-1">Spring Security</span>
                ...
                <div class="card bg-secondary text-white h-100 border-secondary">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="tech-stack-badges">
                                <span class="badge bg-dark text-light me-1 mb-1">Java</span>
                                <span class="badge bg-dark text-light me-1 mb-1">Spring MVC</span>
                                <span class="badge bg-dark text-light me-1 mb-1">MySQL</span>
                                <span class="badge bg-dark text-light me-1 mb-1">JSP</span>
                            </div>
                        </div>
                        <div class="project-meta d-flex justify-content-between align-items-center">
                            <small class="text-muted">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="card bg-secondary text-white h-100 border-secondary">
                    <div class="card-body">
                        ...
                        <div class="project-meta d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                <i class="bi bi-calendar me-1"></i>In Development
                            </small>
